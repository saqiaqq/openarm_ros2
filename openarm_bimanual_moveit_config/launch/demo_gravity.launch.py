...
GRAVITY_URDF_PATH = "/tmp/openarm_bimanual_hw.urdf"
...
def generate_robot_description(
    ...
    """Render Xacro with gravity compensation enabled and persist URDF for HW plugin."""
    ...
    robot_description = xacro.process_file(
        ...
        mappings={
            ...
            "gravity_root_link": "openarm_body_link0",
            "gravity_scale": gravity_scale_str,
        },
    ).toprettyxml(indent="  ")

    with open(GRAVITY_URDF_PATH, "w", encoding="utf-8") as urdf_file:
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "gravity_scale",
            default_value="1.0",
            description="Scale factor applied to KDL gravity feedforward torques.",
        ),
    ]
